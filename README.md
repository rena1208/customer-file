...
JavaScriptでの開発が慣れていないこともあり苦戦しましたがconsole.log()でログを細かく出しながら少しずつ処理を書くよう意識して実装いたしました。

### ○使用状況シート（カレンダー風のUIのページ）
こちらの実装は、こういったカレンダー風のUIの実装をしているような記事や情報がない中での実装で手元で確認しながら試行錯誤を繰り返したため<br>
大変苦労いたしました。<br>
